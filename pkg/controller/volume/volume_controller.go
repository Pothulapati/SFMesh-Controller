...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &sfmeshv1alpha1.Volume{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by Volume - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &sfmeshv1alpha1.Volume{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=sfmesh.k8s.io,resources=volumes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sfmesh.k8s.io,resources=volumes/status,verbs=get;update;patch
func (r *ReconcileVolume) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Volume instance
	instance := &sfmeshv1alpha1.Volume{}
