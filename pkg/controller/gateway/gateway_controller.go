...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileGateway{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &sfmeshv1alpha1.Gateway{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by Gateway - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &sfmeshv1alpha1.Gateway{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=sfmesh.k8s.io,resources=gateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sfmesh.k8s.io,resources=gateways/status,verbs=get;update;patch
func (r *ReconcileGateway) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Gateway instance
	instance := &sfmeshv1alpha1.Gateway{}
