...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &sfmeshv1alpha1.Network{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	return nil
...
// +kubebuilder:rbac:groups=sfmesh.k8s.io,resources=networks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sfmesh.k8s.io,resources=networks/status,verbs=get;update;patch
func (r *ReconcileNetwork) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Network instance
	instance := &sfmeshv1alpha1.Network{}
